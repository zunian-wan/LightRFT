...
def train(args):
    ...
    # configure model
    reward_model = ScalarRewardModelVL(
        args.pretrain,
    ...
    train_dataset = RankDatasetListwiseVL(
        args.train_data,
        tokenizer=tokenizer,
        strategy=strategy,
        processor=processor,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--scale_for_train", action="store_true", default=False, help="Enable learnable scale for train")
