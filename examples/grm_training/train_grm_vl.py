...
def train(args):
    ...
    # configure model
    reward_model = GenerativeRewardModelVL(
        args.pretrain,
    ...
    setattr(reward_model, "is_actor", True)     # To unwrap the base model correctly
    strategy.save_model(
        reward_model,
        tokenizer,
        args.save_path + "/final_checkpoint",
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_path", type=str, default="./ckpt/checkpoints_reward_models")
    ...
    parser.add_argument("--max_pixels", type=int, default=480*784, help="Maximum pixels for each image frame.")
